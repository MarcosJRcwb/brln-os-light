...
func TestBuildUpsertDaily(t *testing.T) {
	...
	if len(args) != 22 {
		t.Fatalf("expected 22 args, got %d", len(args))
	}
	...
	if args[1] != int64(1200) || // forward_fee_revenue_sats
		...
		args[7] != int64(50) || // keysend_received_sats
		args[8] != int64(50000) || // keysend_received_msat
		args[9] != int64(1) || // keysend_received_count
		args[10] != int64(800) || // net_routing_profit_sats
		args[11] != int64(800000) || // net_routing_profit_msat
		args[12] != int64(850) || // net_with_keysend_sats
		args[13] != int64(850000) || // net_with_keysend_msat
		args[14] != int64(4) || // forward_count
		args[15] != int64(2) || // rebalance_count
		args[16] != int64(3) || // payment_count
		args[17] != int64(18000) || // routed_volume_sats
		args[18] != int64(18000000) || // routed_volume_msat
		args[19] != nil || // onchain_balance_sats
		args[20] != nil || // lightning_balance_sats
		args[21] != nil { // total_balance_sats
